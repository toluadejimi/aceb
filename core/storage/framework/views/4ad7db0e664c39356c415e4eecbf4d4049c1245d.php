                        ...
                        <div class="accordion cmn-accordion" id="accordionExample">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <button class="btn btn-warning collapsed" data-bs-toggle="collapse"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="type_0">
                                                    <ul>
                                                        ...
                                                        <li><b>interval(optional) </b> - <?php echo app('translator')->get('Interval in minutes'); ?>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <br>
...
<?php endif; ?>
        ...
        <?php $__env->startPush('breadcrumb-plugins'); ?>
            <a class="btn btn-sm btn-outline--primary text--small" href="<?php echo e(asset('assets/example.txt')); ?>"
               target="_blank">
                <i class="las la-code"></i>
                <?php echo app('translator')->get('Example PHP Code'); ?></a>
    <?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aceboost/core/resources/views/templates/basic/user/api/index.blade.php ENDPATH**/ ?>