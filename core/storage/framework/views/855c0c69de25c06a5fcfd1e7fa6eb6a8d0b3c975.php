                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <strong title="<?php echo app('translator')->get('Amount with charge'); ?>">
                                                <?php echo e(__($general->cur_text)); ?> <?php echo e(showAmount($deposit->amount + $deposit->charge)); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.mainuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aceboost/core/resources/views/templates/basic/user/deposit_history.blade.php ENDPATH**/ ?>