...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('')); ?>/assets/pax/style.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('')); ?>/assets/pax/style2.css">
    <script>
        window.modules = {};
    </script>
</head>
                    ...
                    <div
                        ...
                        <div>
                            <nav class="navbar navbar-expand-lg navbar-light container-fluid"
                                 style="background: #174584; color: white">
                                <div class="navbar-public__header">
                                    ...
                                    <button class="navbar-toggler" type="button" data-toggle="collapse"
                                            data-target="#navbar-collapse-48" aria-controls="navbar-collapse-48"
                                    ...
                                    <div class="d-flex component-navbar-collapse">
                                        ...
                                        <li class="nav-item component-navbar-nav-item component_navbar component-navbar-public-nav-item">
                                            <a class="component-navbar-nav-link component-navbar-nav-link__navbar-public"
                                               style="color: white" href="/user/register"> Sign up</a>
                                        </li>
...
<script type="text/javascript" src="<?php echo e(url('')); ?>/assets/pax/js1.js">
</script>
<script type="text/javascript" src="<?php echo e(url('')); ?>/assets/pax/js2.js">
</script>
<script type="text/javascript" src="https://cdn.mypanel.link/global/h2kji8kp5kndfgga.js">
</script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aceboost/core/resources/views/layout/front.blade.php ENDPATH**/ ?>