                        ...
                        <div class="col-xl-6 col-sm-6 ">
                            <div class="card2 card3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h3>Balance</h3>
                                        <h4 class="text-muted">NGN <?php echo e(number_format(Auth::user()->balance, 2)); ?></h4>
                                    </div>
                        ...
                        <div class="col-xl-6 col-sm-6">
                            <div class="card2 card3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h3>Purchased</h3>
                                        <h4 class="text-muted">NGN <?php echo e(number_format($bought, 2)); ?></h4>
                                    </div>
                        ...
                        <div class="col-xl-6 col-sm-6 ">
                            <div class="card2 card3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h3>All Order</h3>
                                        <h4 class="text-muted"><?php echo e(number_format($total_order, 2)); ?></h4>
                                    </div>
                        ...
                        <div class="col-xl-6 col-sm-6">
                            <div class="card2 card3">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h3>Completed</h3>
                                        <h4 class="text-muted"><?php echo e(number_format($completed_order, 2)); ?></h4>
                                    </div>
