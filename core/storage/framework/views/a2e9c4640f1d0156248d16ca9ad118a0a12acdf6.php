        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-start my-2">
                    <h6>
                        What will your like to do today <strong><?php echo e(Auth()->user()->username); ?></strong>
                    </h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-end text-success count">
                                        NGN <?php echo e(number_format(Auth::user()->balance, 2)); ?></h3>
                                    <span>Balance</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-end text-primary count"><?php echo e(number_format($total_spent, 2)); ?></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-end text-purple count"><?php echo e(number_format($completed_order, 2)); ?></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-end text-danger count"><?php echo e(number_format($pending_order, 2)); ?></h3>
                                ...
                                <table id="empoloyees-tbl3" class="table">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>NGN <?php echo e(number_format($data->price, 2)); ?></td>
...
<?php echo $__env->make($activeTemplate . 'layouts.mainuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aceboost/core/resources/views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>