                            ...
                            <form action="<?php echo e(route('user.order.mass.store')); ?>" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label class="fw-bold"
                                               for="mass_order"><?php echo app('translator')->get('Place mass order (Press Enter button for every new order)'); ?></label>
...
<?php echo $__env->make('layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/aceboost/core/resources/views/templates/basic/user/orders/mess.blade.php ENDPATH**/ ?>