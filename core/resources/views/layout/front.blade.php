...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('')}}/assets/pax/style.css">
    <link rel="stylesheet" type="text/css" href="{{url('')}}/assets/pax/style2.css">
    <script>
        window.modules = {};
    </script>
</head>
...
<script type="text/javascript" src="{{url('')}}/assets/pax/js1.js">
</script>
<script type="text/javascript" src="{{url('')}}/assets/pax/js2.js">
</script>
