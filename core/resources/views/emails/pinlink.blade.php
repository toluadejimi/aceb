                                    ...
                                    <table style="border-collapse: collapse; border-spacing: 0px;"
                                        ...
                                        <tr>
                                            <td style="width: 75px;"><img
                                                    ...
                                                    src="{{url('')}}/assets/pax/logo.svg" alt="logo">
                                                ...
                                                <tr style="height: 20px;">
                                                    <td style="font-size: 0px; padding: 10px 25px; word-break: break-word; height: 20px;"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="margin: 0;"><a href="{{ $data1['link'] }}" class="button" role="button">Click here to reset your pin</a></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody>
