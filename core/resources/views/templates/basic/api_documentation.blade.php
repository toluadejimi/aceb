                        ...
                        <div class="bodywrapper__inner">
                            <div class="row">
                                <div class="d-flex justify-content-end mb-3">
                                    <a class="submit-btn text--small" href="{{ asset('assets/example.txt') }}"
                                       target="_blank">
                                ...
                                <div class="col-lg-12">
                                    <div class="api-docs">
                                        <ul class="api-docs-list">
                                            <li class="api-docs-list__item"><strong
                                                    class="text"> @lang('API URL') </strong> <span
                                                    class="text">{{ route('api.v1') }}</span>
                                            </li>
                                            <li class="api-docs-list__item"><strong
                                                    class="text"> @lang('Response Format')</strong> <span
                                                    class="text">@lang('JSON')</span>
                                            </li>
                                            <li class="api-docs-list__item"><strong
                                                    class="text"> @lang('HTTP Method')</strong> <span
                                                    class="text"> @lang('POST')</span>
                                            </li>
                                            <li class="api-docs-list__item"><strong
                                                    class="text"> @lang('Api Key')</strong> <span
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div id="type_0">
                                                            <ul>
                                                                ...
                                                                <li><b>quantity</b> - @lang('Quantity to be delivered')
                                                                </li>
                                                                <li><b>runs(optional) </b> - @lang('Runs to deliver')
                                                                </li>
                                                                <li><b>interval(optional) </b>
                                                                    - @lang('Interval in minutes')</li>
                                                            </ul>
                                                        </div>
                                                        <br>
                                                        <b>@lang('Success response') :</b>
