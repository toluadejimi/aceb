        ...
        <div class="wrapper-content__body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="{{ route('user.password.request') }}">Forgot
                                                                        password?</a>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div id="block_84">
                <div class="container d-none d-sm-block">
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img src="{{url('')}}/assets/pax/body2.svg" alt="logo">
                        </div>
                    </div>
                </div>
                ...
                <div class="container-sm d-sm-block d-md-none">
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img src="{{url('')}}/assets/pax/bodys2.svg" alt="logo">
                        </div>
                    </div>
                </div>
            ...
            <div id="block_8">
                <div class="container d-none d-sm-block">
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img src="{{url('')}}/assets/pax/body3.svg" alt="logo">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img style="margin-top: -105px; margin-bottom: -170px;"
                                 src="{{url('')}}/assets/pax/bodys3.svg" alt="logo">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="block_84">
                <div class="container d-none d-sm-block">
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img src="{{url('')}}/assets/pax/body4.svg" alt="logo">
                        </div>
                    </div>
                </div>
                ...
                <div class="container-sm d-sm-block d-md-none">
                    <div class="block-signin-text ">
                        <div class="col-lg-12">
                            <img src="{{url('')}}/assets/pax/bodys4.svg" alt="logo">
                        </div>
                    </div>
                </div>
